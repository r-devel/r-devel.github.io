...
<br> The [tutorial presentation slides](https://docs.google.com/presentation/d/16700QHu2YbqK0zCukscSqBOUtTMBAxsa_U7xEUWbT8o/edit#slide=id.p) are publicly available in Google Slides format.

*Note: This video describes the [gettext](https://www.gnu.org/software/gettext/) infrastructure that R uses to internationalize messages. This background information and the tips for translation (first 1h15 of video) are still relevant, but we now recommend translations are added/updated via the [R Project Weblate server](https://translate.rx.studio/projects/r-project/).*
