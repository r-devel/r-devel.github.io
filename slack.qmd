...
::: {.callout-important}
The R Project Slack is being sunsetting in favour of The R Project Zulip. 
Please join the latter instead. More details and guidance can be found on our [Zulip Chat](zulip.qmd) page.
:::
...
[[Join/Go to R Contributors Slack]{.btn .btn-primary role="button" style="font-size: 1.5em;"}](https://join.slack.com/t/r-contributors/shared_invite/zt-49fwcjovp-x2uHIpgQZnX9rxWYRkSS9A)
