 ...
 * [Data Science Learning Community (DSLC) Slack](https://dslc.io) - help with topics from the R4DS book, but also using R/programming in R more generally.
 ...
 * [RLadies+ community Slack](https://airtable.com/appJZFYABfCIdPYMR/pagw7FJB5tm2UQ55o/form) - general help with R on #r-help channel, Slack group is for women and gender minorities only.
 * [rainbowR community Slack](https://docs.google.com/forms/d/e/1FAIpQLSepXotTnoEDaIaflIWXCZNB7dptPqzQsCL6ha2VVHIqgAxXDA/viewform?usp=dialog) - supporting LGBTQ+ people who code in the R language.
